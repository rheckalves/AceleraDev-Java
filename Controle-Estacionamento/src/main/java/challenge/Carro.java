...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            ...
            naoTemPlaca(carro);
            naoTemCor(carro);
            naoTemMotorista(carro);
            return carro;
        }
    }

    private static void naoTemPlaca(Carro carro) throws NullPointerException {
        if (carro.placa == null) {
            throw new NullPointerException();
        }
    }

    private static void naoTemCor(Carro carro) throws NullPointerException {
        if (carro.cor == null) {
            throw new NullPointerException();
        }
    }

    private static void naoTemMotorista(Carro carro) throws EstacionamentoException {
